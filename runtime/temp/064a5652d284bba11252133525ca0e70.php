        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href=<?php echo url("authRule/lst"); ?>>权限管理</a>
                    </li>
                                ...
                                <div id="horizontal-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="pid">
                                                    ...
                                                    <option <?php if($authRules['pid'] == $vo['id']): ?> selected="selected"<?php endif; ?> value="<?php echo $vo['id']; ?>"><?php
                                    echo str_repeat("-",$vo['level']*4);
                                 ?><?php echo $vo['title']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="" name="title"  type="text" value="<?php echo $authRules['title']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="name" placeholder="" name="name"  type="text" value="<?php echo $authRules['name']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
