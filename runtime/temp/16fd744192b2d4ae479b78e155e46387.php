...
<div class="overall">
	...
	<div class="left">
			...
			<?php if(is_array($articles) || $articles instanceof \think\Collection || $articles instanceof \think\Paginator): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<div class="xnews2">
				<div class="pic"><a target="_blank" href="<?php echo url('article/index',array('arid'=>$vo['id'])); ?>"><img src="<?php if($vo['pic'] != ''): ?>http://localhost/tp5/public/static/uploads/<?php echo $vo['pic']; else: ?>http://localhost/tp5/public/static/index/images/error.png <?php endif; ?>" alt=""/></a></div>
				<div class="dec">
