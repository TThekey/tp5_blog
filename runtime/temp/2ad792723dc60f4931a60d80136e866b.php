<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\public/../application/admin\view\admin\edit.html";i:1554472573;s:74:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\application\admin\view\common\top.html";i:1554471984;s:75:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.html";i:1554471984;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>个人博客网站</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            <label  class="col-sm-2 control-label no-padding-right">所属用户组<?php echo $GroupID; ?></label>
                            <div class="col-sm-6">
                                <select name="group_id">
                                    ...
                                    <option <?php if($vo['id'] == $GroupID): ?>selected="selected" <?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></option>
