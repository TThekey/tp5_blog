<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\public/../application/admin\view\auth_group\lst.html";i:1543458481;s:74:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\application\admin\view\common\top.html";i:1541993868;s:75:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.html";i:1543468376;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($authGroupres) || $authGroupres instanceof \think\Collection || $authGroupres instanceof \think\Paginator): $i = 0; $__LIST__ = $authGroupres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('authGroup/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('authGroup/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
