<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\public/../application/admin\view\auth_group\add.html";i:1543817297;s:74:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\application\admin\view\common\top.html";i:1541993868;s:75:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.html";i:1543468376;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            <label  class="col-sm-2 control-label no-padding-right">用户组标题</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label>
                                    <input class="checkbox-slider colored-darkorange" type="checkbox" checked="checked" id="status" name="status" >
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <th>
                                            ...
                                            <input name="rules[]" value="<?php echo $vo['id']; ?>" dataid="id-<?php echo $vo['dataid']; ?>"  class="inverted checkbox-parent <?php if($vo['level'] != 0): ?> checkbox-child <?php endif; ?>"  type="checkbox">
