...
<button type="button" tooltip="添加权限" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url("authRule/add"); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
        ...
        <div class="widget">
            <div class="widget-body">
                <div class="flip-scroll">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($authrules) || $authrules instanceof \think\Collection || $authrules instanceof \think\Paginator): $i = 0; $__LIST__ = $authrules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="xenter"><input type="text" name="<?php echo $vo['id']; ?>" style="width: 50px;text-align: center" value="<?php echo $vo['sort']; ?>"></td>
                                <td><?php
                                    echo str_repeat("-",$vo['level']*8);
                    ...
                    <div><input class="btn btn-primary btn-sm shiny" style="margin-left: 87px;margin-top: 5px" type="submit" value="排序"></div>
                    </form>
                </div>
                <div>
