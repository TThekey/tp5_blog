<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\public/../application/admin\view\links\add.html";i:1541420547;s:74:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\application\admin\view\common\top.html";i:1541993868;s:75:"D:\PHP\phpstudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.html";i:1543468376;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="password" class="col-sm-2 control-label no-padding-right">链接地址</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="password" class="col-sm-2 control-label no-padding-right">链接描述</label>
                            <div class="col-sm-6">
